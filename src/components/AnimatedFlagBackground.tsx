...
const AnimatedFlagBackground: React.FC<AnimatedFlagBackgroundProps> = ({ flagUrl, countryName, geography, worldAtlas, coordinates }) => {
  if (!flagUrl) {
    return (
      <div className="fixed inset-0 -z-10 bg-slate-200 dark:bg-analyst-dark-bg transition-colors duration-500" />
    );
  }
  ...
  return (
    <>
      ...
      `}</style>
      <div className="fixed inset-0 -z-10 overflow-hidden bg-analyst-dark-bg">
        ...
        <div className="absolute inset-0 bg-white/70 dark:bg-analyst-dark-bg/90 backdrop-blur-md z-10"></div>
