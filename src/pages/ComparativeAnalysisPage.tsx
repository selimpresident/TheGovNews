            ...
            <div className="max-w-screen-2xl mx-auto p-4 sm:p-6 lg:p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {selectedCountries.map(countryName => (
                        <div key={countryName} className="bg-white dark:bg-analyst-sidebar rounded-xl border border-slate-200 dark:border-analyst-border p-4 relative">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-bold text-lg text-slate-900 dark:text-analyst-text-primary">{countryMappings.turkishToEnglish.get(countryName)}</h3>
                            </div>
                    ...
                    {selectedCountries.length < 4 && (
                        <button onClick={() => setIsModalOpen(true)} className="flex flex-col items-center justify-center min-h-[20rem] bg-slate-200/50 dark:bg-analyst-input/50 border-2 border-dashed border-slate-300 dark:border-analyst-border rounded-xl text-slate-500 dark:text-analyst-text-secondary hover:bg-slate-200 dark:hover:bg-analyst-input hover:border-analyst-accent hover:text-analyst-accent transition-colors">
