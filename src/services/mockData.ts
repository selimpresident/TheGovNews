import { Article, Source, Topic, Portal, PortalAlert } from '../types';
...
export const MOCK_PORTALS: Portal[] = [
    { id: 'portal_1', name: 'MENA Security Brief', description: 'Tracking defense and diplomacy in the Middle East & North Africa.', countries: ['Türkiye', 'Mısır', 'Suudi Arabistan', 'İran', 'İsrail'], topics: ['defense', 'diplomacy', 'conflict'], isPublic: false, ownerId: 'user_1', collaboratorEmails: ['analyst1@gov.uk', 'teamlead@gov.uk'], createdAt: '2024-07-20T10:00:00Z', lastUpdatedAt: new Date(Date.now() - 1000 * 60 * 15).toISOString() },
    { id: 'portal_2', name: 'G7 Economic Monitor', description: 'Monitoring economic and tech policy across G7 nations.', countries: ['Amerika Birleşik Devletleri', 'Almanya', 'Birleşik Krallık', 'Fransa', 'İtalya', 'Japonya', 'Kanada'], topics: ['economy', 'technology'], isPublic: true, ownerId: 'user_1', collaboratorEmails: [], createdAt: '2024-07-18T14:30:00Z', lastUpdatedAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString() },
    { id: 'portal_3', name: 'Global Health Watch', description: 'Alerts and reports on global health security.', countries: ['Amerika Birleşik Devletleri', 'Çin Halk Cumhuriyeti', 'Hindistan'], topics: ['health'], isPublic: false, ownerId: 'user_1', collaboratorEmails: [], createdAt: '2024-07-22T08:00:00Z', lastUpdatedAt: new Date(Date.now() - 1000 * 60 * 30).toISOString() }
];

export const MOCK_PORTAL_ALERTS: PortalAlert[] = [
    { id: 'alert_1', portalId: 'portal_1', severity: 'high', title: 'UNSC emergency session called regarding Red Sea tensions.', timestamp: new Date(Date.now() - 1000 * 60 * 15).toISOString() },
    { id: 'alert_2', portalId: 'portal_1', severity: 'medium', title: 'New cyber-attack campaign targets financial institutions in the Gulf.', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString() },
    { id: 'alert_3', portalId: 'portal_1', severity: 'low', title: 'Trade negotiations between Egypt and EU show slow progress.', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 8).toISOString() }
];